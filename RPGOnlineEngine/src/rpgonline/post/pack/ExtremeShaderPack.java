...
public class ExtremeShaderPack extends MultiEffect {
	...
	public ExtremeShaderPack() {
		...
		super(new DynamicHeatShader2("get heat"), new FragmentExpose(), new EdgeResample(), new MotionBlur(0.35f), new ColorEffectsShader(1f /*s*/, 0f /*b*/, 1.25f /*c*/, 1.25f /*v*/, 0f /*h*/, 0.8f /*g*/));
	}
}